...
def create_demo_video():
    ...
    for frame_num in range(total_frames):
        ...
        # Thêm text thông tin
        cv2.putText(
            frame, f"Frame: {frame_num + 1}/{total_frames}", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2
        )
        cv2.putText(frame, "Demo Traffic Video", (10, height - 20), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
